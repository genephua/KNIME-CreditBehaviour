...
### Project Details
The project aims to build two predictive models for predicting customer default based on the dataset used.
...
<br /> *Data Source: [Data.xlsx](https://github.com/genephua/Python-MLRModel/blob/main/MLR%20Transformation.ipynb)*
